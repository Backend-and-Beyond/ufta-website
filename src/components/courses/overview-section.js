        ...
        <div className="relative z-10">
          ...
          >
            <p className="text-lg md:text-xl font-medium text-white italic">
              At UFTA, we transform fitness enthusiasts into industry
              professionals through world-class education.
            </p>
          </motion.div>
          ...
          <motion.p
            ...
            custom={2}
          >
            We offer a comprehensive range of fitness education programs
            designed to equip individuals with the knowledge, skills, and
            credentials needed to excel in the fitness industry. Our courses
            range from internationally recognized certifications to specialized
            diplomas and degree programs.
          </motion.p>
          ...
          <motion.p
            ...
            custom={3}
          >
            Our curriculum is meticulously crafted to blend theoretical
            knowledge with practical applications, ensuring our graduates are
            not just academically qualified but also industry-ready. Whether
            you're a newcomer to the fitness field or an experienced
            professional looking to expand your expertise, we have programs
            tailored to meet your specific needs and career aspirations.
          </motion.p>
            ...
            {[
              {
                ...
                text: "Industry-relevant curriculum updated regularly",
              },
              {
                icon: "M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437l1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008z",
                text: "Hands-on practical training in state-of-the-art facilities",
              },
              {
                icon: "M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z",
                text: "Faculty comprised of leading experts and practitioners",
              },
              {
              ...
              },
              {
                ...
                text: "Comprehensive career support and placement assistance",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
              ...
              >
                <svg
                  className="w-5 h-5 md:w-6 md:h-6 text-[#00c8ff] mt-1 flex-shrink-0"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
                ...
                <span className="ml-2 md:ml-3 text-gray-300 text-sm md:text-base">
                  {item.text}
                </span>
              </motion.div>
            ))}
