...
const MerchandiseSection = () => {
  ...
  return (
    ...
    >
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="grid grid-cols-8 h-full">
            {Array.from({ length: 8 }).map((_, i) => (
              <div key={`v-${i}`} className="h-full w-px bg-blue-400/30" />
            ))}
          </div>
          <div className="absolute inset-0 grid grid-rows-8">
            {Array.from({ length: 8 }).map((_, i) => (
              <div key={`h-${i}`} className="w-full h-px bg-blue-400/30" />
            ))}
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <motion.div className="relative mb-1">
            ...
            {/* Static underline */}
            <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 h-0.5 bg-[#00c8ff] w-1/2" />
            
            {/* Static indicators */}
            <div className="absolute -left-6 top-1/2 transform -translate-y-1/2 w-2 h-2 rounded-full bg-[#00c8ff] opacity-70" />
            <div className="absolute -right-6 top-1/2 transform -translate-y-1/2 w-2 h-2 rounded-full bg-[#00c8ff] opacity-70" />
          </motion.div>
      ...
      <motion.div 
        className="bg-[#141414] border border-[#2A2A2A] rounded-lg p-4 md:p-10 text-center hover:border-[#00c8ff] transition-colors duration-300 relative overflow-hidden mx-4 md:mx-0"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.3 }}
      ...
      >
        ...
        <div className="w-full max-w-md mx-auto h-48 md:h-60 bg-gradient-to-r from-[#00c8ff]/20 to-purple-600/20 rounded-lg mb-6 md:mb-10 flex items-center justify-center relative overflow-hidden backdrop-blur-sm border border-[#00c8ff]/30">
          {/* Holographic overlay */}
          ...
          <div className="z-20 relative text-center">
            ...
            <div className="text-lg md:text-xl text-[#00c8ff] font-medium tracking-wider">
              LAUNCHING SOON
            </div>
        ...
        >
          ...
          <span className="absolute -bottom-2 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-[#00c8ff] to-transparent" />
        </motion.h3>
          ...
          >
            ...
            >
              ...
              <div className={`h-40 rounded bg-gradient-to-br ${selectedItem.color} mb-6 flex items-center justify-center`}>
                <div className="font-bold text-2xl text-white tracking-wider">
