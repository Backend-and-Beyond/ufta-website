        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          <div className="space-y-6 md:space-y-8">
            {[
              ...
              >
                <motion.h3
                  className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-[#00c8ff] font-poppins relative z-10"
                >
                  {item.title}
                </motion.h3>
                
                <motion.p
                  className="text-sm md:text-base text-gray-400 relative z-10"
                >
                  {item.content}
                </motion.p>
              </motion.div>
          ...
          <div className="space-y-6 md:space-y-8">
            {[
              {
                title: "Our Approach",
                content: "We blend cutting-edge theoretical knowledge with hands-on practical training, ensuring our students receive a well-rounded education. Our curriculum is continuously updated to reflect the latest industry trends, scientific advancements, and best practices in fitness training methodologies."
              },
              {
                title: "Our Vision",
                content: "To be recognized as the gold standard in fitness education across India, producing graduates who not only excel in their careers but also positively impact public health outcomes through their expertise, innovation, and commitment to wellness."
              }
            ].map((item, index) => (
              <motion.div
                key={index}
