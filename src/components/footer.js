        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://facebook.com/ufta"
                aria-label="Follow UFTA on Facebook"
              ...
              <a
                href="https://twitter.com/ufta"
                aria-label="Follow UFTA on Twitter"
                className="text-gray-400 hover:text-white"
              >
                <svg
                  className="w-6 h-6"
              ...
              <a
                href="https://instagram.com/ufta"
                aria-label="Follow UFTA on Instagram"
                className="text-gray-400 hover:text-white"
              >
                <svg
                  className="w-6 h-6"
