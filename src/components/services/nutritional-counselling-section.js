    ...
    >
          ...
          {Array.from({ length: 15 }).map((_, i) => (
            <React.Fragment key={i}>
              <motion.div 
                ...
                style={{ top: `${i * 30}px`, transform: 'rotate(30deg)', transformOrigin: 'left center' }}
                animate={{ opacity: [0.2, 0.5, 0.2] }}
                transition={{ duration: 2, repeat: Infinity, delay: i * 0.2 }}
              />
              <motion.div 
                className="absolute w-12 h-px bg-[#00c8ff]"
                style={{ top: `${i * 30 + 15}px`, transform: 'rotate(-30deg)', transformOrigin: 'left center' }}
                animate={{ opacity: [0.2, 0.5, 0.2] }}
      ...
      <div className="relative z-10 mb-12">
        <div className="flex flex-col items-center justify-center">
          ...
          >
            Online/Offline Nutritional <span className="text-[#00c8ff] relative">
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 h-full flex items-center justify-center">
              <div className="text-white font-bold text-xl tracking-wide flex flex-col items-center">
                ...
                <span className="text-sm mt-2 opacity-80 tracking-wider">PERSONALIZED PLANS</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.p 
            ...
            custom={1}
          >
            UFTA's certified sports nutritionists and exercise scientists offer personalized online and offline nutritional counselling. We develop <span className="text-amber-400 font-normal">evidence-based dietary plans</span> tailored to your specific fitness goals, whether for athletic performance enhancement, weight management, improving body composition, or overall health and wellness.
          </motion.p>
          ...
          <motion.p 
            ...
            custom={2}
          >
            Our approach is <span className="text-amber-400 font-normal">scientific, practical, and sustainable</span>.
          </motion.p>
        ...
        >
          ...
          <motion.p 
            ...
            custom={1}
          >
            Gain expertise in the science of sports nutrition and learn to advise athletes and active individuals effectively.
          </motion.p>
            ...
            >
              ...
              <h4 className="font-semibold text-amber-400 mb-3 flex items-center">
                <motion.span 
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                />
                Accredited Advanced Diploma in Sports & Exercise Nutrition (Level-6):
              </h4>
              ...
              <ul className="list-none pl-4 text-gray-300 space-y-2 text-sm">
                ...
                <li className="flex items-center">
                  ...
                  <span className="ml-2">Details on duration and eligibility will be provided upon inquiry</span>
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="list-none pl-4 text-gray-300 space-y-2 text-sm">
                ...
                <li className="flex items-center">
                  ...
                  <span className="ml-2">Courses like Nutrition Tech (CNT) and Nutrition Consultant (CNC)</span>
                </li>
              </ul>
            </motion.div>
          </motion.div>
          ...
          <motion.a 
            ...
            whileTap={{ scale: 0.95 }}
          >
            <span className="relative z-10">Enroll in Course</span>
            <motion.span 
              className="absolute inset-0 bg-gradient-to-r from-amber-500/0 via-amber-500/20 to-amber-500/0 transform translate-x-[-100%]"
              animate={{ translateX: ['100%', '-100%'] }}
              transition={{ duration: 1.5, repeat: Infinity, repeatType: "loop", ease: "linear" }}
