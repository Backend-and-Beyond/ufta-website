    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          variants={fadeInUp}
        >
          Our proven 4-step placement process ensures you find the perfect role
          that matches your skills, experience, and career aspirations.
        </motion.p>
      </motion.div>
        ...
        >
          {[
            ...
            },
            {
              ...
              description:
                "Creating compelling professional profiles and portfolios",
              color: "green",
              icon: (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              {/*               <div className="bg-[#0F0F0F] rounded-lg p-3 border border-[#2A2A2A] text-left">
                <h5 className="text-xs font-semibold text-[#00c8ff] mb-2">
                  What to expect:
                </h5>
