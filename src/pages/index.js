        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card p-6 rounded-sm">
              <h3 className="text-xl font-semibold mb-4 font-poppins">Professional Certifications</h3>
              <p className="text-gray-400 font-poppins">Internationally recognized courses to become a certified fitness professional.</p>
            </div>
            <div className="card p-6 rounded-sm">
              <h3 className="text-xl font-semibold mb-4 font-poppins">S&C Training</h3>
              <p className="text-gray-400 font-poppins">Elite Strength & Conditioning training for peak athletic performance.</p>
            </div>
            <div className="card p-6 rounded-sm">
              <h3 className="text-xl font-semibold mb-4 font-poppins">Nutritional Counselling</h3>
              <p className="text-gray-400 font-poppins">Personalized, evidence-based nutrition plans for health and fitness goals.</p>
            </div>
            <div className="card p-6 rounded-sm">
              <h3 className="text-xl font-semibold mb-4 font-poppins">High Performance Clinic</h3>
              <p className="text-gray-400 font-poppins">Specialized services including sports rehabilitation and biomechanics analysis.</p>
            </div>
            <div className="card p-6 rounded-sm">
              <h3 className="text-xl font-semibold mb-4 font-poppins">Gym Setup Support</h3>
              <p className="text-gray-400 font-poppins">Guidance on gym equipment, sourcing, and franchise opportunities.</p>
            </div>
            <div className="card p-6 rounded-sm">
              <h3 className="text-xl font-semibold mb-4 font-poppins">Job Placement Assistance</h3>
          ...
          >
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Link to="/services" className="inline-block bg-white text-black hover:bg-gray-200 px-8 py-3 font-medium font-poppins transition-colors duration-200">
          ...
          >
            <div className="grid md:grid-cols-3 gap-10 items-center">
              ...
              <motion.div 
                ...
                variants={slideInRight}
              >
                <h3 className="text-3xl font-bold text-white mb-4 font-poppins">Bibhu Moni Singha</h3>
            ...
            <motion.div 
              ...
              variants={fadeInUp}
            >
              <h3 className="text-xl font-semibold mb-8 text-center font-poppins">Qualifications</h3>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="card p-4 rounded-sm">
                  <h4 className="font-semibold text-amber-400 mb-2 font-poppins">Master Trainer TECHNOGYM</h4>
                  <p className="text-gray-400 text-sm font-poppins">Certified Master Trainer for TECHNOGYM, specializing in advanced fitness equipment and training programs.</p>
                </div>
                <div className="card p-4 rounded-sm">
                  <h4 className="font-semibold text-amber-400 mb-2 font-poppins">IUSCA/USAW Level 2</h4>
                  <p className="text-gray-400 text-sm font-poppins">Certified Strength and Conditioning Coach with expertise in Olympic weightlifting.</p>
                </div>
                <div className="card p-4 rounded-sm">
                  <h4 className="font-semibold text-amber-400 mb-2 font-poppins">MPPT & CSN PROPTA USA</h4>
                  <p className="text-gray-400 text-sm font-poppins">Certified in Mental Performance and Sports Nutrition from PROPTA USA.</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
