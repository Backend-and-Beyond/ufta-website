      ...
      >
        <AnimatePresence>
          {displayedImages.map((image, index) => (
            <motion.div
              key={image.id}
              className="relative group cursor-pointer overflow-hidden rounded-xl bg-[#141414] border border-[#2A2A2A] hover:border-purple-400/60 transition-all duration-500"
