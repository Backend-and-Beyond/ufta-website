...
const InteractiveApprovalBadge = ({ 
  ...
  return (
    ...
    >
      <motion.div
        className="bg-gradient-to-br from-[#141414] via-[#1a1a1a] to-[#141414] border border-[#2A2A2A] rounded-2xl p-6 cursor-pointer relative overflow-hidden group"
      ...
      >
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center">
            ...
            >
              {icon || (
                <svg className="w-6 h-6" style={{ color: badgeColor }} fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Main Content */}
        <p className="text-gray-300 text-sm leading-relaxed mb-4">{details}</p>
