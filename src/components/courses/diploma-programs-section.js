    ...
    >
      <div className="flex flex-col items-center justify-center mb-8 md:mb-12">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white text-center relative group">
          Professional{" "}
          <span className="text-[#00c8ff] inline-block relative">
            Diploma Programs
            <motion.span
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/4 mb-6 md:mb-0 flex justify-center">
              ...
              >
                <div
                  className="absolute inset-0 w-full h-full bg-[rgba(0,200,255,0.03)] rounded-full animate-pulse"
                  style={{ animationDuration: "4s" }}
                ></div>
                <svg
                  className="w-24 h-24 md:w-28 lg:w-32 md:h-28 lg:h-32 text-[#00c8ff] relative z-10"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
            ...
            <div className="w-full md:w-3/4 md:pl-8">
              <motion.div
                ...
                custom={2}
              >
                <p className="text-base md:text-lg lg:text-xl font-medium text-white italic">
                  Our diploma programs are designed to provide industry-ready
                  skills for those looking to excel in specific fitness
                  disciplines.
                </p>
              </motion.div>
              ...
              <motion.p
                ...
                custom={3}
              >
                UFTA's professional diploma programs combine theoretical
                knowledge with extensive practical training to ensure graduates
                are fully prepared for the demands of the modern fitness
                industry. Each program includes a mandatory internship period to
              ...
              >
                {[
                  {
                    text: "Internationally recognized credentials",
                    icon: "M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z",
                  },
                  {
                    text: "Taught by industry professionals",
                    icon: "M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z",
                  },
                  {
                    text: "Extensive practical training",
                    icon: "M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446A9 9 0 1 1 12 3ZM6.75 13.5a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 0-1.5h-6Zm.75-6.75a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 0 1.5h-3a.75.75 0 0 1-.75-.75Z",
                  },
                  {
                    text: "Guaranteed internship placement",
                  ...
                  >
                    <div className="bg-[#00c8ff]/10 rounded-full w-10 h-10 md:w-12 md:h-12 flex items-center justify-center mb-2 md:mb-3">
                      <svg
                        className="w-5 h-5 md:w-6 md:h-6 text-[#00c8ff]"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        strokeWidth="1.5"
        ...
        <motion.div
          ...
          variants={staggerContainer}
        >
          {/* Strength and Conditioning Coach or Practitioner */}
          <motion.div
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-300 mb-4 text-sm">
                Sports scientists, trainers, physiotherapists, and coaches
                aiming to work in high-performance settings.
              </p>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Key Learning Areas:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-4 text-sm space-y-1">
                <li>Applied sport science and athlete profiling</li>
                <li>Periodization and performance programming</li>
                <li>Biomechanics, RFD, and injury prevention</li>
                <li>Monitoring, load management, and recovery</li>
              </ul>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Career Pathways:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-4 text-sm space-y-1">
                <li>High-performance sport academies</li>
                <li>Collegiate and professional teams</li>
                <li>Military/tactical strength programs</li>
                <li>Research or performance labs</li>
              </ul>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Scope of Work:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-6 text-sm space-y-1">
                <li>
                  Design and implement training programs to enhance athletic
                  performance
                </li>
                <li>Conduct biomechanical and physiological assessments</li>
                <li>Monitor athlete load and recovery</li>
                <li>
                  Collaborate with sports scientists, physiotherapists, and
                  coaches
                </li>
              </ul>
              <motion.div
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-300 mb-4 text-sm">
                Fitness professionals, gym instructors, or entrepreneurs
              ...
              <ul className="list-disc list-inside text-gray-300 mb-4 text-sm space-y-1">
                <li>Client assessment and goal setting</li>
                <li>Program design and progression</li>
                <li>Functional and corrective training</li>
                <li>Business development and online coaching</li>
              </ul>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Career Pathways:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-4 text-sm space-y-1">
                ...
                <li>Private personal training studios</li>
                <li>Freelance or online coaching</li>
                <li>Corporate wellness roles</li>
              </ul>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Scope of Work:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-6 text-sm space-y-1">
                <li>
                  Conduct client assessments and develop individualized fitness
                  programs
                </li>
                <li>
                  Guide clients through exercise technique, lifestyle coaching,
                  and goal-setting
                </li>
                <li>
                  Work in gyms, private studios, health clubs, or independently
                </li>
                <li>
                  Specialize in corrective, functional, or transformation
                  training
                </li>
              </ul>
              <motion.div
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-300 mb-4 text-sm">
                Health coaches, personal trainers, and nutrition science
                students.
              </p>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Key Learning Areas:
              ...
              <ul className="list-disc list-inside text-gray-300 mb-4 text-sm space-y-1">
                <li>Performance and clinical nutrition</li>
                <li>Supplementation strategies and hydration</li>
                <li>Nutritional periodization</li>
                <li>Body composition and energy balance</li>
              </ul>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Career Pathways:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-4 text-sm space-y-1">
                <li>Work with athletes or fitness clients</li>
                <li>Integrate into S&C or rehab teams</li>
                <li>Lead body transformation programs</li>
                <li>Engage in consulting, education, or research</li>
              </ul>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Scope of Work:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-6 text-sm space-y-1">
                <li>
                  Assess dietary habits and sport-specific nutrition needs
                </li>
                <li>Create evidence-based nutrition plans</li>
                <li>Guide supplementation and recovery strategies</li>
                <li>
                  Operate in clinical, coaching, or transformation settings
                </li>
              </ul>
              <motion.div
                whileHover={{ scale: 1.05 }}
          ...
          {/* Sports Injury Rehabilitation and Return to Performance Specialist */}
          <motion.div
            className="bg-gradient-to-br from-[#141414] to-[#1a1a1a] border border-[#2A2A2A] rounded-xl overflow-hidden shadow-lg group hover:shadow-[0_0_25px_rgba(0,200,255,0.15)] transition-all duration-500"
            variants={fadeInUp}
            custom={7}
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-300 mb-4 text-sm">
                Physiotherapists, sports rehab professionals, and S&C coaches.
              </p>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Key Learning Areas:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-4 text-sm space-y-1">
                <li>Musculoskeletal injury assessment</li>
                <li>Evidence-based rehabilitation planning</li>
                <li>Return-to-play criteria and performance testing</li>
                <li>Strength reconditioning and corrective methods</li>
              </ul>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Career Pathways:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-4 text-sm space-y-1">
                <li>Rehabilitation clinics and sports medicine centers</li>
                <li>High-performance return-to-play departments</li>
                <li>Collaborate with orthopedic and physio teams</li>
                <li>Lead specialist rehab and performance setups</li>
              </ul>
              <p className="text-gray-400 mb-2 text-sm font-semibold">
                Scope of Work:
              </p>
              <ul className="list-disc list-inside text-gray-300 mb-6 text-sm space-y-1">
                <li>Design and implement rehabilitation protocols</li>
                <li>Use evidence-based return-to-play methods</li>
                <li>
                  Work in multidisciplinary clinical and sport environments
                </li>
                <li>Support athletes in safe return to competition</li>
              </ul>
              <motion.div
                whileHover={{ scale: 1.05 }}
                transition={{ duration: 0.2 }}
          ...
          <div className="relative z-10">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-white">
                Why Choose UFTA Diploma Programs?
              </h3>
            </div>
              ...
              {[
                {
                  ...
                  text: "Our curriculum is designed with industry input to ensure you graduate with the exact skills employers are seeking.",
                },
                {
                  title: "Placement Assistance",
                  text: "We have partnerships with leading fitness centers, sports academies and corporate wellness programs across India.",
                },
                {
                  title: "Flexible Learning",
                  text: "Choose from weekday, weekend, and part-time schedules to balance your education with other commitments.",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
