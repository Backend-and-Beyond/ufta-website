...
const HighPerformanceIntroSection = () => {
  return (
    <section className="py-16 relative">
      ...
      <div className="bg-gradient-to-b from-[#141414] to-[#0A0A0A] border border-[#2A2A2A] rounded-xl p-10 relative shadow-xl max-w-5xl mx-auto overflow-hidden transition-all duration-300 hover:border-[#00c8ff]/50">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
          ...
          <div className="md:w-2/3">
            ...
            <div className="space-y-4">
              <p className="text-lg text-gray-300 leading-relaxed border-l-2 border-[#00c8ff]/30 pl-4">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a 
                href="#services" 
                className="inline-flex items-center gap-2 bg-[#00c8ff] text-black hover:bg-[#00c8ff]/90 px-6 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
              >
              ...
              <a 
                href="#contact" 
                className="inline-flex items-center gap-2 border border-[#2A2A2A] hover:border-[#00c8ff] text-white hover:text-[#00c8ff] px-6 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105"
              >
                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="md:w-1/3 space-y-4">
            {[
              ...
              { number: "1000+", label: "Athletes Trained", icon: "M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0014.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" },
              { number: "95%", label: "Success Rate", icon: "M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }
            ].map((stat, idx) => (
              <div
                key={idx}
                className="bg-[#141414] border border-[#2A2A2A] rounded-lg p-4 flex items-center gap-4 group hover:border-[#00c8ff] transition-all duration-300 transform hover:-translate-y-1"
              >
      ...
      <div className="flex flex-wrap justify-center gap-6 mt-10">
        {[
          ...
          <span 
            key={idx}
            className={`px-4 py-2 rounded-full text-sm font-medium ${badge.color} border transition-transform duration-300 hover:-translate-y-1`}
          >
            {badge.text}
          </span>
        ))}
