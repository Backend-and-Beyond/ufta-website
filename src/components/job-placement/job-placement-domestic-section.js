      ...
      icon: (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 0112 20.904a14.98 14.98 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5"
          />
        </svg>
      ),
      ...
      icon: (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0112 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z"
          />
        </svg>
      ),
    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          variants={fadeInUp}
        >
          UFTA provides placements for Personal Trainers, S&C Coaches, and
          Sports Nutritionists in a wide array of esteemed organizations across
          India:
        </motion.p>
            ...
            <motion.button
              ...
              className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                idx === 0
                  ...
                  : "bg-[#1A1A1A] text-gray-300 border border-[#2A2A2A] hover:border-[#00c8ff] hover:text-[#00c8ff]"
              }`}
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {domesticPlacements.map((placement, index) => (
          ...
          >
            ...
            <p className="text-gray-400 mb-6">{placement.description}</p>
