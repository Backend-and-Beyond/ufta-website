...
const ContactFormSection = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="bg-[#141414] border border-[#2A2A2A] rounded-lg p-6 md:p-10 relative overflow-hidden z-10 max-w-6xl mx-auto shadow-xl"
        variants={animations.fadeInUp}
        custom={1}
      >
        ...
        <motion.p 
          className="text-center text-xl leading-relaxed mb-10 text-gray-300 max-w-2xl mx-auto"
          variants={animations.fadeInUp}
          custom={2}
        >
          Interested in our services? <span className="text-[#00c8ff] font-medium">Contact us</span> today to start your fitness journey with UFTA.
        </motion.p>
        
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          {/* Contact Form */}
          <motion.form 
            className="mt-8 space-y-6 relative flex-1"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-300 flex items-center">
                  <motion.span 
                ...
                <div className="relative">
                  <motion.input 
                    ...
                    required
                    aria-required="true"
                    whileFocus={{ borderColor: '#00c8ff', boxShadow: '0 0 0 1px rgba(0, 200, 255, 0.3)' }}
                  />
                  <motion.div 
              ...
              <motion.div
                ...
                className="md:col-span-1"
              >
                <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-300 flex items-center">
                  <motion.span 
                    className="inline-block w-1.5 h-1.5 rounded-full bg-[#00c8ff] mr-2"
                    animate={{ opacity: [0.5, 1, 0.5] }}
            ...
            <motion.div
              ...
              custom={3}
            >
              <label htmlFor="service" className="block mb-2 text-sm font-medium text-gray-300 flex items-center">
                <motion.span 
                  className="inline-block w-1.5 h-1.5 rounded-full bg-[#00c8ff] mr-2"
                  animate={{ opacity: [0.5, 1, 0.5] }}
              ...
              <div className="relative">
                ...
                <motion.div 
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#00c8ff" className="w-4 h-4">
            ...
            <motion.div
              ...
              custom={4}
            >
              <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-300 flex items-center">
                <motion.span 
                  className="inline-block w-1.5 h-1.5 rounded-full bg-[#00c8ff] mr-2"
                  animate={{ opacity: [0.5, 1, 0.5] }}
            ...
            >
              <motion.button 
                ...
                className="relative bg-transparent border border-[#00c8ff] text-white hover:bg-[#00c8ff]/10 px-8 py-3 rounded-md overflow-hidden transition-all duration-300 w-full"
                whileHover={{ 
                  scale: 1.02,
          ...
          <motion.div 
            className="mt-8 relative flex-1 lg:max-w-sm bg-[#1A1A1A] rounded-lg p-6 border border-[#2A2A2A]"
            variants={animations.fadeInUp}
            custom={6}
          >
            <h3 className="text-xl font-semibold text-white mb-6 flex items-center">
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <motion.a 
                    ...
                    className="text-[#00c8ff] hover:underline block text-sm mb-1"
                    whileHover={{ x: 2 }}
                  >
                    +91-9864047046
                  </motion.a>
                  <motion.a 
                    ...
                    className="text-[#00c8ff] hover:underline block text-sm"
                    whileHover={{ x: 2 }}
                  >
                    +91-9864026682
                  </motion.a>
              ...
              >
                ...
                <div>
                  ...
                  <motion.a 
                    href="mailto:info@bibhuuniversalfitness.com" 
                    className="text-[#00c8ff] hover:underline block text-sm"
                    whileHover={{ x: 2 }}
                  >
                    info@bibhuuniversalfitness.com
                  </motion.a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm">
                    Universal Fitness Training Academy<br />
              ...
              <div className="pt-6 mt-6 border-t border-[#2A2A2A]">
                ...
                <div className="flex space-x-3">
                  <motion.a 
                    ...
                    className="p-3 bg-[#141414] rounded-full border border-[#2A2A2A] hover:border-[#00c8ff] transition-colors duration-300"
                    whileHover={{ y: -4, boxShadow: '0 4px 12px rgba(0, 200, 255, 0.3)' }}
                  >
                    <svg className="w-5 h-5 text-[#00c8ff]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <AnimatePresence>
          {formStatus === 'success' && (
            ...
            >
              ...
              >
                <motion.div 
                  className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-[#00c8ff] flex items-center justify-center"
                  animate={{ 
                    boxShadow: [
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#00c8ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </motion.div>
                <h3 className="text-2xl text-white font-bold mb-2">Message Sent</h3>
                <p className="text-gray-300">Thank you for contacting UFTA. We'll respond to your inquiry shortly.</p>
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
