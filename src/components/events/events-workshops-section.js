        ...
        {workshops.map((workshop, index) => (
          ...
          >
            ...
            <div className={`relative overflow-hidden rounded-t-xl bg-gradient-to-br ${workshop.bgColor} border-b border-[#2A2A2A] group-hover:border-[#00c8ff]/30 transition-colors duration-500`}>
              <div className="p-4 md:p-8 h-24 md:h-32 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-2 md:mb-4 rounded-full bg-white/10 flex items-center justify-center backdrop-blur-sm">
                    <svg className="w-6 h-6 md:w-8 md:h-8 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex-grow flex flex-col p-4 md:p-6">
              ...
              <div className="mb-3 md:mb-4">
                <span className="inline-block px-2 md:px-3 py-1 text-xs font-medium bg-[#00c8ff]/10 text-[#00c8ff] rounded-full border border-[#00c8ff]/20">
                  {workshop.date.includes("2025") ? workshop.date.split(":")[0].trim() : "Coming Soon"}
                </span>
              </div>
              
              {/* Workshop Title */}
              <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-white group-hover:text-[#00c8ff] transition-colors duration-300">
                {workshop.title}
              </h3>
              
              {/* Workshop Date */}
              <p className="text-xs md:text-sm text-gray-400 mb-3 md:mb-4 font-medium flex items-center">
                <svg className="w-3 h-3 md:w-4 md:h-4 mr-1 text-[#00c8ff]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
              ...
              <p className="text-gray-300 mb-4 md:mb-5 text-xs md:text-sm leading-relaxed flex-grow">
                {workshop.description}
              </p>
