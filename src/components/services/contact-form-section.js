          ...
          >
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              >
                ...
                <div>
                  <h4 className="text-white font-medium mb-1 text-sm md:text-base">Phone</h4>
                  <motion.a 
              ...
              >
                ...
                <div>
                  <h4 className="text-white font-medium mb-1 text-sm md:text-base">Address</h4>
              ...
              <div className="pt-4 md:pt-6 mt-4 md:mt-6 border-t border-[#2A2A2A]">
                <h4 className="text-white font-medium mb-3 md:mb-4 text-sm md:text-base">Connect With Us</h4>
                <div className="flex space-x-2 md:space-x-3">
                  ...
                  >
                    <svg className="w-4 h-4 md:w-5 md:h-5 text-[#00c8ff]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            >
              ...
              >
                <motion.div 
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-[#00c8ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </motion.div>
                <h3 className="text-xl md:text-2xl text-white font-bold mb-2">Message Sent</h3>
                <p className="text-gray-300 text-sm md:text-base">Thank you for contacting UFTA. We'll respond to your inquiry shortly.</p>
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
