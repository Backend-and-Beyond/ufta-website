  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center mb-8 md:mb-12">
        ...
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-bold text-white text-center relative group">
      ...
      <motion.div 
        className="bg-gradient-to-br from-[#141414] to-[#1a1a1a] border border-[#2A2A2A] rounded-xl p-6 md:p-12 relative overflow-hidden max-w-6xl mx-auto shadow-[0_0_25px_rgba(0,200,255,0.1)]"
        variants={fadeInUp}
        whileHover={{ 
      ...
      >
        ...
        <div className="relative z-10">
          <motion.div 
            className="mb-4 md:mb-6 border-l-4 border-[#00c8ff] pl-4 md:pl-6 py-2"
            variants={fadeInUp}
            custom={1}
          >
            <p className="text-base md:text-lg lg:text-xl font-medium text-white italic">Finding the right educational path is crucial for your fitness career success.</p>
          </motion.div>
          
          <motion.p 
            className="text-gray-300 leading-relaxed mb-6 md:mb-8 text-sm md:text-base lg:text-lg"
            variants={fadeInUp}
            custom={2}
          >
          ...
          <motion.div 
            className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-10"
            variants={staggerContainer}
            custom={3}
          >
            <motion.div 
              className="bg-[#0D0D0D] p-6 md:p-8 rounded-xl border border-[#2a2a2a] shadow-lg relative overflow-hidden group"
              variants={fadeInUp}
              whileHover={{ y: -5, transition: { duration: 0.2 } }}
            >
              <div className="absolute top-0 right-0 w-20 h-20 md:w-24 md:h-24 -mr-6 md:-mr-8 -mt-6 md:-mt-8 opacity-10">
              ...
              <div className="flex items-center mb-4">
                <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#00c8ff]/20 flex items-center justify-center mr-3">
                ...
                <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-white group-hover:text-[#00c8ff] transition-colors duration-300">Entry-Level Professionals</h3>
              </div>
              
              <div className="pl-11 md:pl-13 mb-4 md:mb-5">
                <p className="text-gray-400 mb-4 text-sm md:text-base">Perfect for those beginning their fitness career or transitioning from another field.</p>
              </div>
              ...
              <div className="w-full h-0.5 bg-gradient-to-r from-transparent via-[#00c8ff]/30 to-transparent mb-4 md:mb-5"></div>
            ...
            >
              ...
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-white group-hover:text-[#00c8ff] transition-colors duration-300">Advanced Professionals</h3>
              </div>
              
              <div className="pl-11 md:pl-13 mb-4 md:mb-5">
                <p className="text-gray-400 mb-4 text-sm md:text-base">Designed for fitness professionals looking to specialize and advance their careers.</p>
              </div>
          ...
          <motion.div 
            className="bg-[#0D0D0D]/70 rounded-xl p-6 md:p-8 border border-[#2a2a2a] mb-6 md:mb-8"
            variants={fadeInUp}
            custom={4}
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {[
                ...
                <motion.div 
                  ...
                  whileHover={{ x: 5, transition: { duration: 0.2 } }}
                >
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#00c8ff]/10 flex items-center justify-center mr-3 flex-shrink-0 mt-1">
                    <svg className="w-4 h-4 md:w-5 md:h-5 text-[#00c8ff]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
          ...
          <motion.div 
            className="flex flex-col md:flex-row items-center justify-between bg-gradient-to-r from-[#00c8ff]/10 to-transparent p-4 md:p-6 rounded-lg border border-[#00c8ff]/20"
            variants={fadeInUp}
            custom={5}
          >
            <div className="mb-4 md:mb-0 text-center md:text-left">
              <h4 className="text-lg md:text-xl font-bold text-white mb-1">Still unsure which course is right for you?</h4>
              <p className="text-gray-300 text-sm md:text-base">Our expert advisors are here to help guide your educational journey.</p>
            </div>
            
            <motion.a 
              href="tel:+919864047046" 
              className="px-4 py-2 md:px-6 md:py-3 bg-[#00c8ff] text-black font-bold rounded-md shadow-lg hover:shadow-xl transition-all duration-300 inline-flex items-center whitespace-nowrap text-sm md:text-base"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <svg className="w-4 h-4 md:w-5 md:h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
